...
MAINTAINER_UNIVERSITY_ID = '20260000000'
...
COLLEGE_META = {
    '经济学院': (
        '国家级重点学科，涵盖理论经济学、应用经济学、金融学等方向，培养经济分析与管理人才。',
        'https://econ.scu.edu.cn',
    ),
    '法学院': (
        '中国法学教育重镇，拥有法学一级学科博士点，在宪法与行政法、民商法、刑法等领域具有深厚学术积淀。',
        'https://law.scu.edu.cn',
    ),
    '文学与新闻学院': (
        '文理工医交叉融合，拥有中国语言文学、新闻传播学两个一级学科博士点，培养文化传播与创意产业人才。',
        'https://lj.scu.edu.cn',
    ),
    '外国语学院': (
        '涵盖英、日、俄、德、法、西班牙等多语种，拥有外国语言文学一级学科博士点。',
        'https://flc.scu.edu.cn',
    ),
    '艺术学院': (
        '集美术、设计、音乐、舞蹈、戏剧影视于一体的综合性艺术学院，注重艺术创新与实践。',
        'https://art.scu.edu.cn',
    ),
    '数学学院': (
        '基础数学国家理科基地，入选国家基础学科拔尖学生培养计划2.0，在代数、几何、拓扑等领域享有盛誉。',
        'https://math.scu.edu.cn',
    ),
    '物理学院': (
        '物理学国家理科基地，拥有物理学一级学科博士点，在凝聚态物理、原子分子物理等方向实力雄厚。',
        'https://physics.scu.edu.cn',
    ),
    '化学学院': (
        '化学国家理科基地，绿色化学与可持续催化研究国内领先，拥有化学一级学科博士点。',
        'https://chem.scu.edu.cn',
    ),
    '生命科学学院': (
        '生物学国家理科基地，在植物学、动物学、微生物学、遗传学等方向具有深厚学术积累。',
        'https://life.scu.edu.cn',
    ),
    '电子信息学院': (
        '信息与通信工程国家一级重点学科培育，涵盖电子科学与技术、信息与通信工程，产教融合特色鲜明。',
        'https://ee.scu.edu.cn',
    ),
    '计算机学院': (
        '计算机科学与技术一级学科博士点，人工智能、大数据、网络空间安全为特色方向，产学研紧密结合。',
        'https://cs.scu.edu.cn',
    ),
    '建筑与环境学院': (
        '建筑学与土木工程双轮驱动，在绿色建筑、BIM技术、环境工程等领域具有鲜明特色。',
        'https://ace.scu.edu.cn',
    ),
    '水利水电学院': (
        '水利工程国家重点学科，在水资源开发利用、水灾害防治、水环境保护等方面具有国际影响力。',
        'https://wrh.scu.edu.cn',
    ),
    '电气工程学院': (
        '电气工程一级学科博士点，在电力系统及其自动化、高电压与绝缘技术等方向具有显著优势。',
        'https://ee.scu.edu.cn',
    ),
    '商学院': (
        '工商管理一级学科博士点，MBA/EMBA教育国内知名，企业管理和会计学为特色方向。',
        'https://bs.scu.edu.cn',
    ),
    '华西临床医学院（华西医院）': (
        '中国西部疑难危急重症诊疗中心，临床医学学科ESI全球前1‰，附属医院综合实力全国领先。',
        'https://wcsh.scu.edu.cn',
    ),
    '华西口腔医学院': (
        '口腔医学学科全国第一，拥有口腔医学国家重点实验室和口腔疾病研究国家临床医学研究中心。',
        'https://hxkq.scu.edu.cn',
    ),
    '华西药学院': (
        '药学一级学科博士点，在药物化学、药剂学、药理学、临床药学等方向具有深厚研究基础。',
        'https://pharmacy.scu.edu.cn',
    ),
    '华西基础医学与法医学院': (
        '基础医学一级学科博士点，在人体解剖学、病理学、法医学等方向具有鲜明特色。',
        'https://jcyx.scu.edu.cn',
    ),
    '华西公共卫生学院': (
        '公共卫生与预防医学一级学科博士点，流行病学、卫生统计学为国家级特色方向。',
        'https://gw.scu.edu.cn',
    ),
    '马克思主义学院': (
        '全国重点马克思主义学院，马克思主义理论一级学科博士点，在思政教育和理论研究方面发挥引领作用。',
        'https://marx.scu.edu.cn',
    ),
    '历史文化学院（旅游学院）': (
        '历史学国家文科基础学科人才培养基地，考古学、中国史、世界史三个一级学科博士点。',
        'https://history.scu.edu.cn',
    ),
    '公共管理学院': (
        '公共管理一级学科博士点，在行政管理、社会保障、土地资源管理等方向具有较强研究实力。',
        'https://spa.scu.edu.cn',
    ),
    '材料科学与工程学院': (
        '材料科学与工程一级学科博士点，在金属材料、无机非金属材料、高分子材料等方向具有特色。',
        'https://mse.scu.edu.cn',
    ),
    '机械工程学院': (
        '机械工程一级学科博士点，智能制造、机器人技术、增材制造为特色方向。',
        'https://me.scu.edu.cn',
    ),
}
...
MOCK_USERS = [
    ...
    {
        'university_id': '20260000009',
        'nickname': '医学生小华',
        'role': 'student',
        'trust_score': 93,
        'display_name': '华西医学生',
        'college': '华西临床医学院（华西医院）',
    },
    {
        'university_id': '20260000010',
        'nickname': '建筑狮',
        'role': 'student',
        'trust_score': 84,
        'display_name': '建筑系学长',
...
COURSE_DATA: dict[str, list[tuple[str, str, str, float, str]]] = {
    '计算机学院': [
        ...
        (
            ...
            '必修',
            3.5,
            'TCP/IP协议栈、应用层、传输层、网络层、链路层、网络安全',
        ),
        (
            '数据库系统概论',
            'shujuku-xitong',
    ...
    '电子信息学院': [
        ...
        (
            ...
            '选修',
            3.0,
            'ARM架构、RTOS、外设驱动、嵌入式Linux、物联网应用',
        ),
    ],
    '电气工程学院': [
        (
    ...
    '经济学院': [
        ...
        (
            ...
            '必修',
            3.0,
            '国民收入核算、IS-LM模型、AD-AS模型、经济增长与波动',
        ),
        (
            '计量经济学',
            'jiliang-jingji',
...
def _build_parts(tpl: dict, course_name: str) -> list[dict] | None:
    ...
    if category == '实验报告' and fmt in ('docx', 'pdf'):
        parts = [
            {
                'filename': f'{course_name}_实验报告.{fmt}',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_report.{fmt}',
                'file_size': random.randint(500_000, 5_000_000),
                'format': fmt,
            },
            {
                'filename': f'{course_name}_实验数据.xlsx',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_data.xlsx',
        ...
        if random.random() > 0.4:
            parts.append(
                {
                    'filename': f'{course_name}_源码.zip',
                    'storage_key': f'mock/storage/{random.randint(10000, 99999)}_code.zip',
    ...
    if category == '习题集' and '代码' in tpl.get('title', ''):
        return [
            {
                'filename': f'{course_name}_源码.zip',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_src.zip',
                'file_size': random.randint(100_000, 5_000_000),
                'format': 'zip',
            },
            {
                'filename': f'{course_name}_说明文档.pdf',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_readme.pdf',
    ...
    if category == '教材':
        return [
            {
                'filename': f'{course_name}_上册.pdf',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_vol1.pdf',
                'file_size': random.randint(20_000_000, 80_000_000),
                'format': 'pdf',
            },
            {
                'filename': f'{course_name}_下册.pdf',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_vol2.pdf',
                'file_size': random.randint(15_000_000, 60_000_000),
                'format': 'pdf',
            },
        ]
    ...
    if random.random() < 0.25:
        return [
            {
                'filename': f'{course_name}_主文件.{fmt}',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_main.{fmt}',
                'file_size': random.randint(500_000, 20_000_000),
                'format': fmt,
            },
            {
                'filename': f'{course_name}_附录.{fmt}',
                'storage_key': f'mock/storage/{random.randint(10000, 99999)}_appendix.{fmt}',
...
async def seed():
    async with async_session() as db:
        ...
        for mu in MOCK_USERS:
            encrypted_university_id = encrypt_pii(mu['university_id'])
            university_id_lookup = blind_index_pii(mu['university_id'])
            result = await db.execute(
                select(User).where(User.university_id_lookup == university_id_lookup)
            )
            user = result.scalar()
            if not user:
                user = User(
            ...
            mock_users[mu['university_id']] = user

        encrypted_maintainer = encrypt_pii(MAINTAINER_UNIVERSITY_ID)
        maintainer_lookup = blind_index_pii(MAINTAINER_UNIVERSITY_ID)
        result = await db.execute(
            select(User).where(User.university_id_lookup == maintainer_lookup)
        )
        maintainer = result.scalar()
        if not maintainer:
            maintainer = User(
                university_id=encrypted_maintainer,
                university_id_lookup=maintainer_lookup,
                university_verified_at=datetime.now(timezone.utc),
                nickname='管理员',
                role='maintainer',
                trust_score=100,
        ...
        for mu in MOCK_USERS:
            college_users.setdefault(mu['college'], []).append(mock_users[mu['university_id']])

        for course in all_courses:
            college_name = next(
                (cn for cn, cl in colleges.items() if cl.id == course.college_id), None
            )
            ...
            for tpl in templates:
                ...
                m = Material(
                    ...
                    - timedelta(days=random.randint(0, days_ago)),
                )
                db.add(m)
        ...
        # ── 5. Seed ratings ──
        result = await db.execute(
            select(Material.id, Material.average_rating, Material.rating_count).where(
        ...
        for mid, _avg, rc in all_materials:
            existing = await db.scalar(
                sa_text('SELECT COUNT(*) FROM ratings WHERE material_id = :mid').bindparams(mid=mid)
            )
            if existing:
                continue
            n = min(rc, 30)
            for _ in range(n):
                score = max(
                    1, min(5, random.choices([1, 2, 3, 4, 5], weights=[3, 8, 20, 35, 34])[0])
                )
                await db.execute(
                    sa_text(
        ...
        # ── 6. Seed collections ──
        top_materials = sorted(new_materials, key=lambda m: m.download_count or 0, reverse=True)[
            :80
        ]
        collection_count = 0
        ...
        for user in random.sample(user_list, 20):
            ...
            for m in bookmarked_materials:
                existing = await db.execute(
                    sa_text(
                        'SELECT 1 FROM bookmarks WHERE user_id = :uid AND material_id = :mid'
            ...
            for c in bookmarked_courses:
                existing = await db.execute(
                    sa_text(
                        'SELECT 1 FROM bookmarks WHERE user_id = :uid AND course_id = :cid'
        ...
        for user in user_list:
            ...
            if user_materials:
                badge_count += await _ensure_badge(
                    db, user.id, 'first_upload', '首次上传', '第一次上传资料'
                )
            if len(user_materials) >= 10:
                badge_count += await _ensure_badge(
                    db, user.id, 'prolific_10', '高产作者·铜', '累计上传10份资料'
                )
            if len(user_materials) >= 50:
                badge_count += await _ensure_badge(
                    db, user.id, 'prolific_50', '高产作者·银', '累计上传50份资料'
                )
            top_dl = max((m.download_count or 0) for m in user_materials) if user_materials else 0
            if top_dl >= 100:
                badge_count += await _ensure_badge(
                    db, user.id, 'popular_100', '人气之星', f'资料最高下载量 {top_dl}'
                )
            if top_dl >= 1000:
                badge_count += await _ensure_badge(
                    db, user.id, 'popular_1000', '人气之星·银', f'资料最高下载量 {top_dl}'
                )
            if random.random() < 0.3:
                badge_count += await _ensure_badge(
                    db, user.id, 'selfless', '无私奉献', '上传资料后持续维护'
                )
            if random.random() < 0.15:
                badge_count += await _ensure_badge(
                    db, user.id, 'continuous_3', '持之以恒', '连续3个学期贡献资料'
                )
        ...
        print(
            f'Done. DB: {len(colleges)} colleges ({colleges_with_data} with courses), {cc} courses, '
