...
| `export_tags.py` | Exports the cover pool from `cover_match_simulation.py` to `scustack-web/public/covers/tags.json`. | After changing the cover pool in the simulation |
